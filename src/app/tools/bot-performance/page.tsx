...
const FALLBACK_STRATEGIES: BotStrategy[] = [
  ...
  },
  {
    ...
    name: "LuxAlgo EMA Trend v3.2 (TradingView)",
    description: "EMA 13/89/200 + Chop Index + ADX — 4AI 리뷰 완료, TradingView 실행",
    strategyDetail: {
      ...
      backtestResults: [
        { period: "v3.2 (최종): 2025.01~26.03", returnPct: "+10.53%", winRate: "75.0%", sharpe: "—", mdd: "-3.78%" },
        { period: "v3.1 (버그수정): 동일 기간", returnPct: "+8.27%", winRate: "71.4%", sharpe: "—", mdd: "-3.76%" },
        { period: "v3 (버그 있음): 동일 기간", returnPct: "+22.58%", winRate: "61.1%", sharpe: "—", mdd: "-7.08% (과대평가)" },
        { period: "PF 비교", returnPct: "v3.2: 3.58 / v3.1: 3.05 / v3: 2.43", winRate: "—", sharpe: "—", mdd: "—" },
      ],
      liveExpectation: {
