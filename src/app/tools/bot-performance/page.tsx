...
const FALLBACK_STRATEGIES: BotStrategy[] = [
  {
    id: "seykota-ema",
    name: "Seykota EMA v3.1 Bot",
    description: "EMA 15/60 + MA200 하락장 필터 + ADX + RSI + ATR 동적손절 — ChatGPT 리뷰 반영",
    strategyDetail: {
      summary: "Ed Seykota의 추세추종 철학을 v3.1로 업그레이드. ChatGPT 리뷰 반영하여 치명적 버그 8건 수정. 포지션 복구 시 진입가 보존(reconcile), 실제 체결가 사용(UUID 조회), 일봉 1회 분석 + 15분 모니터링 분리, 멀티코인 전체 잔고 스캔, INVEST_RATIO 반영, RSI NaN 방지, ATR Wilder 통일. 12년(2013~2026) 백테스트 +23,367%, PF 7.89.",
      regimes: [
      ...
      liveExpectation: {
        ...
        reasons: [
          ...
          "ChatGPT 리뷰 반영: 체결가 조회, 포지션 복구, RSI NaN 등 8건 버그 수정",
        ],
        caveats: [
