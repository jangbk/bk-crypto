  ...
  },
  {
    ...
    strategyDetail: {
      ...
      backtestResults: [
        ...
        { period: "2020", returnPct: "+15.1%", winRate: "-", sharpe: "-", mdd: "-" },
        { period: "2021", returnPct: "-3.6%", winRate: "-", sharpe: "-", mdd: "-" },
        { period: "2022", returnPct: "+7.5%", winRate: "-", sharpe: "-", mdd: "-" },
        { period: "2023", returnPct: "+11.2%", winRate: "-", sharpe: "-", mdd: "-" },
        { period: "2024", returnPct: "+8.0%", winRate: "-", sharpe: "-", mdd: "-" },
        { period: "2025", returnPct: "+6.0%", winRate: "-", sharpe: "-", mdd: "-" },
        { period: "2026 (3개월)", returnPct: "+6.3%", winRate: "-", sharpe: "-", mdd: "-" },
      ],
      liveExpectation: {
