...
const FALLBACK_STRATEGIES: BotStrategy[] = [
  ...
  },
  {
    ...
    name: "LuxAlgo EMA Trend v3.3 (TradingView)",
    ...
    strategyDetail: {
      ...
      backtestResults: [
        { period: "v3.3 (최종): 2025.01~26.03", returnPct: "+10.68%", winRate: "81.8%", sharpe: "—", mdd: "-3.76%" },
        { period: "v3.2 (Chop 추가)", returnPct: "+10.53%", winRate: "75.0%", sharpe: "—", mdd: "-3.78%" },
        { period: "v3.1 (버그수정)", returnPct: "+8.27%", winRate: "71.4%", sharpe: "—", mdd: "-3.76%" },
        { period: "PF 비교", returnPct: "v3.3: 4.97 / v3.2: 3.58 / v3.1: 3.05", winRate: "—", sharpe: "—", mdd: "—" },
      ],
      liveExpectation: {
