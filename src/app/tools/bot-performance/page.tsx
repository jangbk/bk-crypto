...
const FALLBACK_STRATEGIES: BotStrategy[] = [
  {
    ...
    strategyDetail: {
      ...
      backtestResults: [
        { period: "2020.1 ~ 2022.12", returnPct: "-", winRate: "-", sharpe: "-", mdd: "-" },
        { period: "2023.1 ~ 2024.12", returnPct: "-", winRate: "-", sharpe: "-", mdd: "-" },
        { period: "2025.1 ~ 현재", returnPct: "-", winRate: "-", sharpe: "-", mdd: "-" },
      ],
      liveExpectation: {
        pythonReturn: "백테스트 도구에서 직접 확인",
        websiteReturn: "백테스트 도구에서 직접 확인",
        expectedReturn: "BTC 상승장에서 강력, 횡보/하락장에서 손실 가능",
        reasons: [
          "Seykota 전략은 강한 상승 추세에서 큰 수익을 내는 구조",
          "ATR 밴드로 변동성에 따라 진입/청산 기준이 자동 조절됨",
          "EMA100은 약 3개월 추세를 반영하여 노이즈 필터링",
        ],
        caveats: [
          "롱(매수)만 가능 — 하락장에서는 현금 보유 상태",
          "횡보장에서 잦은 진입/청산으로 수수료 누적 가능",
          "전액 투입 전략이라 낙폭이 BTC 하락폭에 근접",
          "장기 추세 전략이므로 단기 성과 판단은 부적합 (최소 3개월 관찰 필요)",
        ],
      },
    },
    asset: "BTC/KRW",
