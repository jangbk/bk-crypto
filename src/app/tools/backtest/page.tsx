...
const STRATEGIES: Strategy[] = [
  ...
  {
    id: "bot-rsi-meanrev",
    name: "🤖 RSI MeanRev Bot (Bybit) — 횡보장 전용",
    description: "BB+RSI 평균회귀. Alpha v4가 SIDEWAYS일 때 이 봇이 거래",
    params: ["RSI 과매도", "RSI 과매수", "ADX 최대"],
    paramHints: [
      "RSI가 이 값 이하면 매수. 기본 25",
      "RSI가 이 값 이상이면 매도. 기본 75",
      "ADX가 이 값 이하(횡보)일 때만 거래. 기본 25",
    ],
    isBotStrategy: true,
  },
  {
    id: "bot-bybit-v6-hybrid",
    name: "🤖 Bybit v6 Adaptive (비활성)",
    description: "일봉 레짐 + 60분봉 추세추종 — Alpha v4로 교체됨",
    params: ["ROC 임계 (%)", "SL (ATR배수)", "TP (ATR배수)"],
    paramHints: [
      "30일 수익률 임계값. BULL>5%, BEAR<-3%. 기본 5",
      "스탑로스 ATR 배수. 2.0 기본",
      "테이크프로핏 ATR 배수. 4.0 기본",
    ],
    isBotStrategy: true,
  },
];
